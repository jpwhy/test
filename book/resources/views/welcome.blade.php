...
<header>
    <div class="quotes">
        ...
        <div class="flower"><img src="./index/images/flower.jpg"></div>
    </div>
    <!--nav begin-->
    <div id="nav">
        <ul>
            <li><a href="admin/user/photo">首页</a></li>
            <li><a href="#">关于我</a></li>
            <li><a href="#">碎言碎语</a></li>
            <li><a href="#">慢生活</a></li>
            <li><a href="#">模板分享</a></li>
...
<div class="photowall">
    <ul class="wall_a">
        <li><a href="/"><img src="./index/images/p01.jpg">
                <figcaption>
                    <h2>不再因为别人过得好而焦虑，在没有人看得到你的时候依旧能保持节奏 </h2>
                </figcaption>
            </a></li>
        <li><a href="/"><img src="./index/images/p02.jpg">
                <figcaption>
                    <h2>不再因为别人过得好而焦虑，在没有人看得到你的时候依旧能保持节奏 </h2>
                </figcaption>
            </a></li>
        <li><a href="/"><img src="./index/images/p03.jpg">
                <figcaption>
                    <h2>不再因为别人过得好而焦虑，在没有人看得到你的时候依旧能保持节奏 </h2>
                </figcaption>
            </a></li>
        ...
        <li><a href="/"><img src="./index/images/p04.jpg">
                <figcaption>
                    <h2>不再因为别人过得好而焦虑，在没有人看得到你的时候依旧能保持节奏 </h2>
                </figcaption>
            </a></li>
        ...
        <li><a href="/"><img src="./index/images/p05.jpg">
                <figcaption>
                    <h2>不再因为别人过得好而焦虑，在没有人看得到你的时候依旧能保持节奏 </h2>
                </figcaption>
            </a></li>
        <li><a href="/"><img src="./index/images/p06.jpg">
                <figcaption>
                    <h2>不再因为别人过得好而焦虑，在没有人看得到你的时候依旧能保持节奏 </h2>
                </figcaption>
            </a></li>
...
<div class="about">
    <ul>
        ...
        <div class="about_girl"><span><a href="/"><img src="./index/images/girl.jpg"></a></span>
            <p>初遇时，他的幽默，他往日的深情、承诺和傻劲儿，两个人共度的美丽时刻，一一印在我的回忆里....</p>
        </div>
        <div class="about_boy"><span><a href="/"><img src="./index/images/boy.jpg"></a></span>
...
<div class="blank"></div>
<div class="blog">
    <figure> <a href="/"><img src="./index/images/t01.jpg"></a>
